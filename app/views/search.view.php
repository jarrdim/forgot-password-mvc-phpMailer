...
<a href="<?php echo ROOT?>/details" class="btn-dark">BACK</a>
            ...
            <div class="col-md-12 ">
                <div class="card w-100 ">
                    <div class="card-body text-start">
                        ...
                        <div class="card-text ">
                             <input  oninput="look(this.value);"  placeholder="Enter something to search eg. inte/mg/1766/09/20" class="form-control mb-3 ">  
                        </div>
